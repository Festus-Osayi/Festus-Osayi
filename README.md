...
<img src='https://skillicons.dev/icons?i=js,html,c,cpp,css,express,github,mysql,nextjs,nodejs,postgres,py,react,sequelize,tailwind,vscode,linux,docker,kubernetes,ansible,terraform,grafana&perline=6' alt="skills"/>
<hr>
